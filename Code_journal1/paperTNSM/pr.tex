...
Network slicing is a key technology in 5G wireless systems. Specifically, it isolates network resources into slices, e.g., via core slicing and/or radio access network (RAN) slicing, for serving various services\cite{shen2020ai,setayesh2020joint,popovski20185g}. 
...
\begin{figure}
  \centering
    \includegraphics[scale = 0.30]{fig/cell.pdf}
    %\includegraphics[max height=30cm,max width=9.5cm]{Drawing15.eps}
    %\includegraphics[width=\textwidth]{finalDraw.pdf}
    \vspace{-1mm}
