...
for episode in range(episodes):
    ...
    for k in range(max_steps):
        ...
        if done:
            break
        if episode > 8: #np.random.uniform(0, 1) > epsilon: #episode > 1800: 
