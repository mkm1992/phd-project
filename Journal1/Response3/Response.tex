...
We would like to thank the Editor for his comments and for giving us this opportunity to improve our paper. We have used the comments to improve our paper and eliminate problems. We are confident that we were able to address the reviewers’ and editor’s suggestions.
...
In Fig. \ref{fig:2}, the mean total delay is indicated according to the number of iterations of the
...
\vspace*{-1\baselineskip}
\noindent \textbf{Response:\\}
Based on this comment, we added Table I reporting the list of acronyms to our paper as follows to relieve the reviewer's concern.
...
\vspace*{-1\baselineskip}
\noindent \textbf{Response:\\}
Based on this comment, we added Table I reporting the list of acronyms to the paper shown below to address the reviewer's concern.
