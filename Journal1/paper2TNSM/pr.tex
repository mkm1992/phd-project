...
\textcolor{magenta}{Considering propagation and transmission delays is straightforward to add to the system, but we did not consider them for better presentation and focus on obtaining the optimal number of VNF.
...
We consider 25 PRBs are used in the network and the packet size for mMTC is equal to 20 bytes, and for URLLC is equal to 32 bytes.
