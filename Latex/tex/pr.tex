...
In fig. \ref{fig:f1}, the ratio of admitted slices that connected to just one DC is demonstrated for two different number of DCs with different number of slices (the parameters for simulation listed in table \ref{table:1}). When number of DCs are low, proposed method and optimal method have approximately same ratio of admitted slices.   
\begin{figure}[H]
  \centering
