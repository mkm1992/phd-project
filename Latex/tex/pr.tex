...
Heuristic algorithms is proposed to each of sub-problems in order to simultaneously connect slices to services, optimize power consumption and connect slices to physical resources to minimize cost of active DCs.
\end{abstract}
