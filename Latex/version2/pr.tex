...
Since the first part of sun-problem is 3D-bin packing problem which is NP-hard, we need heuristic algorithm. In \cite{3dbin}, a heuristic algorithm is defined based on sorting bins according to a measurement.
