...
Since the first part of sub-problem is 3D-bin packing problem which is NP-hard, we need heuristic algorithm. In \cite{3dbin}, a heuristic algorithm is defined based on sorting bins according to a measurement.
The details of the heuristic algorithm are represented in algorithm \ref{alg}\cite{3dbin}.
\begin{algorithm}
