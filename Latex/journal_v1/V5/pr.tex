...
Two different methods are used to compare with the performance of the proposed method (IABV).
 The first one is a baseline scheme, which used random PRB allocation. The association of O-RU is based on the distance, channel quality, and the fronthaul capacity. Also, the number of activated VNF for each slice is obtained from the simulation. 
