...
Nowadays, RAN virtualization attracts significant attention from  both industry and academia since it 
...
In \cite{SystemCostMinimization}, the authors solve the problem of obtaining beamforming and VMs activation 
in C-RAN system with limited fronthaul capacity. The goal of the paper is to minimize the energy cost, with the system delay, fronthaul capacity and rate constraint. 
