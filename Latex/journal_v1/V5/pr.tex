...
Assume we have six 4-antenna O-RU (MISO) located in a place with a diameter of 500 meters as it shown in figure \ref{fig:cell}. In addition, we consider the users placed randomly in this place.
\begin{figure}
  \centering 
  ...
  \label{fig:cell}
\end{figure}
We consider 25 PRB in the network.
