...
&+\sum\limits_{s=1}^{S} \sum\limits_{i=1}^{U_s}\mathfrak{h}_{u_{(s,i)}} (\mathcal{\bar{R}}_{u_{(s,i)}}-\mathcal{R}_{u_{(s,i)}}^{max})
+\sum\limits_{s=1}^{S} \sum\limits_{i=1}^{U_s}\kappa_{u_{(s,i)}} (\mathcal{\bar{R}}_{u_{(s,i)}}-\varpi_{u_{(s,i)}})\\
&+\sum\limits_{s=1}^{S} \sum\limits_{i=1}^{U_s}\xi_{u_{(s,i)}} (\mathcal{\bar{R}}_{u_{(s,i)}}-\lambda_{u_{(s,i)}})\\
&-  \sum\limits_{r=1}^{R} \mathfrak{m}_{r} (P_{r}-\sigma_{q_r}^2 \times 2^{C^{r}_{max}} )\\
&-  \sum\limits_{r=1}^{R} \mathfrak{v}_{r} (P_{r}-P_{max})\\
