...
int parse_arguments(struct ntttcp_test *test, int argc1, char **argv1)
{
	...
	int opt =0;
	printf("hello mojdeh\n");
	//opt = getopt_long(2, "-s 0.0.0.0", "r::s::DMLeHm:P:n:l:6up:f::b:B:W:t:C:Nx::O::Vh", longopts, NULL);
	printf("%d",opt);
